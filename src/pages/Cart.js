    ...
    <div className="cart-section container mx-auto py-10">
      ...
      <div className="cart-lower flex justify-between items-start py-10">
        ...
        <div className="flex flex-col items-start gap-2">
          ...
          <Link className="checkout bg-sky-500 w-full py-3 uppercase font-medium text-sky-50 tracking-widest hover:bg-sky-600 duration-300 text-center">
            Checkout
          </Link>
          <Link className="continune uppercase text-sky-500 font-medium">
            Continue Shopping
          </Link>
        </div>
      </div>
